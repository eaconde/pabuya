...
class Admin::EventsControllerTest < ActionController::TestCase
  ...
  test "should create admin_event" do
    assert_difference('Admin::Event.count') do
      post :create, admin_event: { date_from: @admin_event.date_from, date_to: @admin_event.date_to, description: @admin_event.description, name: @admin_event.name }
    end
  ...
  test "should update admin_event" do
    patch :update, id: @admin_event, admin_event: { date_from: @admin_event.date_from, date_to: @admin_event.date_to, description: @admin_event.description, name: @admin_event.name }
    assert_redirected_to admin_event_path(assigns(:admin_event))
  end
